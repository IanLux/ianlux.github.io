...
const ContactBar: React.FC = () => {
  ...
  return (
    <div className="contact-bar">
      <span className="contact-name">Ian Doles</span>
      <div className="contact-links">
        <a href={`mailto:${personalInfo.email}`} className="contact-link" title="Email">
        ...
        <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="contact-link" title="LinkedIn">
        ...
        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="contact-link" title="Resume">
